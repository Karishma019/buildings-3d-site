...
const LocationMap = () => {
  return (
    ...
    >
      <div className="bg-neutral_0 gap-3 lg:gap-0 w-96 flex lg:flex-row flex-col items-start p-6 md:w-1/2 lg:w-1/3 rounded-3xl shadow-2xl -translate-x-1/2 absolute top-40 left-1/2">
